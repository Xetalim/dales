...
!> Performs the resolved budget calculations
  ...
  subroutine do_stressbudget
    ...
    select case(iadv_mom)
      case(iadv_cd2)
        call hadvecu_2nd(u_mean,u_term)
        call vadvecu_2nd(u_mean,u_term)
        call hadvecv_2nd(v_mean,v_term)
        call vadvecv_2nd(v_mean,v_term)
        call hadvecw_2nd(w_mean,w_term)
        call vadvecw_2nd(w_mean,w_term)
      case(iadv_5th)
        call hadvecu_5th(u_mean,u_term)
        call vadvecu_5th(u_mean,u_term)
        call hadvecv_5th(v_mean,v_term)
        call vadvecv_5th(v_mean,v_term)
        call hadvecw_5th(w_mean,w_term)
        call vadvecw_5th(w_mean,w_term)
      case(iadv_cd6)
        call hadvecu_6th(u_mean,u_term)
        call vadvecu_6th(u_mean,u_term)
        call hadvecv_6th(v_mean,v_term)
        call vadvecv_6th(v_mean,v_term)
        call hadvecw_6th(w_mean,w_term)
        call vadvecw_6th(w_mean,w_term)
      case default
   ...
   select case(iadv_mom)
      case(iadv_cd2)
        call hadvecu_2nd(u0_dev,u_term)
        call vadvecu_2nd(u0_dev,u_term)
        call hadvecv_2nd(v0_dev,v_term)
        call vadvecv_2nd(v0_dev,v_term)
        call hadvecw_2nd(w0_dev,w_term)
        call vadvecw_2nd(w0_dev,w_term)
      case(iadv_5th)
        call hadvecu_5th(u0_dev,u_term)
        call vadvecu_5th(u0_dev,u_term)
        call hadvecv_5th(v0_dev,v_term)
        call vadvecv_5th(v0_dev,v_term)
        call hadvecw_5th(w0_dev,w_term)
        call vadvecw_5th(w0_dev,w_term)
      case(iadv_cd6)
        call hadvecu_6th(u0_dev,u_term)
        call vadvecu_6th(u0_dev,u_term)
        call hadvecv_6th(v0_dev,v_term)
        call vadvecv_6th(v0_dev,v_term)
        call hadvecw_6th(w0_dev,w_term)
        call vadvecw_6th(w0_dev,w_term)
      case default
          stop "Unknown advection scheme "
   end select
